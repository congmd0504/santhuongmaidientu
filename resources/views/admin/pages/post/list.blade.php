                            ...
                            <form action="{{ route('admin.post.index') }}" method="GET">
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-0">
                                        ...
                                        <a  class="btn btn-danger w-40" href="{{ route('admin.post.index') }}">Làm mới</a>
                                    </div>
                        ...
                        <table class="table table-head-fixed" style="font-size:13px;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            <li><strong>Tên </strong> {{optional($postItem->admin)->name}}</li>
                                            <li><strong>Email </strong> {{optional($postItem->admin)->email}}</li>
                                        </ul>
