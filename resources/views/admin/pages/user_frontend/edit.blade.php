...
<div class="content-wrapper">
   ...
   <div class="content">
	 ...
	 <div class="form-group">
                                                <div class="row">
                                                    <label class="col-sm-2 control-label" for="">Chọn Level</label>
                                                    <div class="col-sm-10">
                                                        <select class="form-control custom-select" id="" value="{{ old('level') }}" name="level">
                                                            @foreach (config("point.level") as $key => $itemLevel)
                                                            <option value="{{ $key }}" @if( (old('level')?? $data->level)== $key){{'selected'}} @endif>{{ $itemLevel }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
