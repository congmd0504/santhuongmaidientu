                ...
                <ul class="row">
                    ...
                    <li class="col-sm-12">
                        <div class="avatar text-center p-3">
                            ...
                            <h4> <strong>Trạng thái thông tin</strong>   {{ $user->status==1?"Chưa KYC":"Đã KYC" }} - {{ getNameLevel($user->level) }}</h4>
                        </div>
                    </li>
                    ...
                    <li class="col-sm-12 col-md-6">
                        <strong>Ảnh cmt mặt trên </strong> <br>
                        <img src="{{ $user->cmt_mattren_path?$user->cmt_mattren_path: $shareFrontend['userNoImage'] }}" alt="{{ $user->name }}" class="mb-3" style="width:60px;">
                    </li>
                    <li class="col-sm-12 col-md-6">
                        <strong>Ảnh cmt mặt dưới </strong> <br>
                        <img src="{{ $user->cmt_matduoi_path?$user->cmt_matduoi_path: $shareFrontend['userNoImage'] }}" alt="{{ $user->name }}" class="mb-3" style="width:60px;">
                    </li>
