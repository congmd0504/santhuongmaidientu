                        ...
                        <div id="sidebar-profile" class="pt-3 ">
                            <div class="avatar text-center ">
                                <div class="bgr-img-avatar"
                                    style="background-image: url(https://quangcaominhlong.vn/wp-content/uploads/2020/12/nen-background-tet-hoa-dao_105958650.png)">
                            ...
                            @if (isset($postsHotNew) && $postsHotNew->count() > 0)
                                <div class="pd-profile">
                                    ...
                                    <div class="baner-profile-mobile ">
                                        ...
                                        {{-- <a href="">
                                        <img src="https://img.meta.com.vn/data/image/2022/12/29/banner-tet-2.jpg"
                                            alt="">
                                    </a> --}}
                                    </div>
                                </div>
                            ...
                            <div class="pd-profile">
                                <nav class="mt-2 background-color-white sodu-mobile border-radius-5">
                                    <div class="title-sodu">
                                        <h6>Số dư ví</h6>
                                        <span
                                            class="">{{ number_format($user->points()->where('active', 1)->whereIn('type', config('point.listTypePointMH'))->get()->sum('point')) }}đ<i
                                    ...
                                    <ul class="nav nav-pills nav-sidebar " data-widget="treeview" role="menu"
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ route('profile.index', ['type' => 2]) }}">
                                                <div class="icon-profile color-icon-profile-1"><i
                                                        class="fas fa-edit"></i></div>
                                                <p class="text-center">Nạp xu bằng sử dụng điểm</p>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ route('profile.lichSuRutTien') }}">
                            ...
                            <div class="pd-profile">
                                <nav class="mt-2 background-color-white khampha-mobile border-radius-5">
                                    <div class="title-sodu">
                                        <h6>Thưởng thu nhập</h6>
                                        <span
                                            class="">{{ number_format($user->points()->where('active', 1)->whereIn('type', config('point.listTypePointRut'))->get()->sum('point')) }}đ
                            ...
                            <div class="pd-profile-2 display-flex">
                                <div class="alert alert-success  hidden-scroll " style="overflow: auto;">
                                    <input type="text"
                                        value="{{ route('profile.register-referral.create', ['code' => $user->code]) }}"
                                        id="myInput" style="background-color: transparent; border:unset;">
                                </div>
