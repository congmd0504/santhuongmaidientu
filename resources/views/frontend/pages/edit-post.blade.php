...
@section('title', $seo['title'] ?? 'Sửa bài đăng')
@section('keywords', $seo['keywords'] ?? 'Sửa bài đăng')
@section('description', $seo['description'] ?? 'Sửa bài đăng')
@section('abstract', $seo['abstract'] ?? 'Sửa bài đăng')
                                                ...
                                                <div class="col-md-9">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="description" class="form-control" cols="30" rows="10" style="height:120px;"
                                                            placeholder="Nhập nội dung...">{{ $data->description }}</textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-12 none" style="padding:0 15px !important">
                                                    <div class="form-group">
                                                        <label for="">Nhập nội dung</label>
                                                        <textarea name="content" class="form-control tinymce_editor_init" cols="30" rows="10"
                                                            placeholder="Nhập nội dung...">{{ $data->content }}</textarea>
                                                    </div>
                                                </div>

                                                <input type="hidden" name="slug" id="slugNew"
                                                    value="{{ $data->slug }}">
                                                <input type="hidden" name="active" value="{{ $data->active }}">
                                                <input type="hidden" name="user_id" value="{{ $user->id }}">
                                                <input type="hidden" name="category_id" value="29">
                                                <input type="hidden" name="title_seo" id="title_seo"
