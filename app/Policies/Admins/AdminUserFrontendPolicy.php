...
class AdminUserFrontendPolicy
{
    ...
    public function exportExcel(Admin $user)
    {
     //   dd($user->CheckPermissionAccess(config('permissions.access.pay-export-excel')));
        return $user->CheckPermissionAccess(config('permissions.access.admin-user_frontend-export-excel'));
    }
    public function napTien(Admin $user)
    {
     //   dd($user->CheckPermissionAccess(config('permissions.access.pay-export-excel')));
        return $user->CheckPermissionAccess(config('permissions.access.admin-user_frontend-napTien'));
    }
    public function banTien(Admin $user)
    {
     //   dd($user->CheckPermissionAccess(config('permissions.access.pay-export-excel')));
        return $user->CheckPermissionAccess(config('permissions.access.admin-user_frontend-banTien'));
    }
    public function upDatePointWhenEndMonth(Admin $user)
    {
     //   dd($user->CheckPermissionAccess(config('permissions.access.pay-export-excel')));
        return $user->CheckPermissionAccess(config('permissions.access.admin-user_frontend-upDatePointWhenEndMonth'));
    }
    public function upDatePointWhenEndYear(Admin $user)
    {
     //   dd($user->CheckPermissionAccess(config('permissions.access.pay-export-excel')));
        return $user->CheckPermissionAccess(config('permissions.access.admin-user_frontend-upDatePointWhenEndYear'));
    }
