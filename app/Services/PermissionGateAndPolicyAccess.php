...
class PermissionGateAndPolicyAccess
{
    ...
    public function defineGateUserFrontend()
    {
        ...
        Gate::define('admin-user_frontend-export-excel', 'App\Policies\Admins\AdminUserFrontendPolicy@exportExcel');
        Gate::define('admin-user_frontend-napTien', 'App\Policies\Admins\AdminUserFrontendPolicy@napTien');
        Gate::define('admin-user_frontend-banTien', 'App\Policies\Admins\AdminUserFrontendPolicy@banTien');
        Gate::define('admin-user_frontend-upDatePointWhenEndMonth', 'App\Policies\Admins\AdminUserFrontendPolicy@upDatePointWhenEndMonth');
        Gate::define('admin-user_frontend-upDatePointWhenEndYear', 'App\Policies\Admins\AdminUserFrontendPolicy@upDatePointWhenEndYear');
    }
    ...
    public function defineGateCodeSale()
    {
        // module role
        Gate::define('code_sale-list', 'App\Policies\Admins\AdminCodeSalePolicy@list');
        Gate::define('code_sale-add', 'App\Policies\Admins\AdminCodeSalePolicy@add');
        Gate::define('code_sale-edit', 'App\Policies\Admins\AdminCodeSalePolicy@edit');
        Gate::define('code_sale-delete', 'App\Policies\Admins\AdminCodeSalePolicy@delete');
    }
}
