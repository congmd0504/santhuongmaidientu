        ...
        if(\App\Models\User::find($id)->status==1){
            $rules= [
               ...
               // "avatar_path"=>"mimes:jpeg,jpg,png,svg|nullable",
				 "avatar_path"=>"max:5000|mimes:jpeg,jpg,png,svg|nullable",
                "cmt_mattren_path"=>"max:5000|mimes:jpeg,jpg,png,svg|nullable",
                "cmt_matduoi_path"=>"max:5000|mimes:jpeg,jpg,png,svg|nullable",
                "password" =>"nullable|min:6",
                "password_confirmation"=>"same:password",

                "phone" => "nullable|min:9|max:11",
